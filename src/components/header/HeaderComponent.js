...
function HeaderComponent() {
    ...
    switch (true) {
        case currentItem === SLUGS.dashboard:
            title = 'Dashboard';
            break;
        case [SLUGS.overview, SLUGS.overviewTwo, SLUGS.overviewThree, SLUGS.overviewFour].includes(currentItem):
            title = 'Creación';
            break;
        case currentItem === SLUGS.tickets:
            title = 'Tickets';
            break;
        case [SLUGS.ideas, SLUGS.ideasTwo, SLUGS.ideasThree, SLUGS.ideasFour].includes(currentItem):
            title = 'Ideas';
            break;
        ...
        <Row className={classes.container} vertical='center' horizontal='space-between'>
            ...
            <Row vertical='center'>
                ...
                <DropdownComponent
                    label={
                        <>
                            <span className={classes.name}>William Izquierdo</span>
                            <img
